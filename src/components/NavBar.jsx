...
const NavBar = () => {
    ...
    return (
        <div className='flex justify-between w-full py-4 fixed top-0 left-0 px-3 md:px-6 lg:px-12 bg-[#d0d0ce]'>
            ...
            <button onClick={() => navigate("/workspace")} className='text-[#1d4537] border border-[#1d4537] hover:bg-[#1d4537] hover:text-white px-6 text-lg font-semibold transition-all duration-500'>Explore</button>
        </div>
    )
}
